...
class RevealedMap(Map):
    import revealedLevelDefs as defs
    name = "The Revealed by AbhinaY"
    playTypes = ["melee", "teamFlag", 'keepAway']
    ...
    def onPreload(cls):
        data = {}
        data['modelTop'] = bs.getModel("natureBackground")
        data['modelBottom'] = bs.getModel("buttonNull")
        ...
        data['modelBGTex'] = bs.getTexture("tipTopBGColor")
        data['collideBG'] = bs.getCollideModel("bigGBumper")
