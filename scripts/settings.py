...
bootstrap_spaz = True
bootstrap_powerup = True
bootstrap_bomb = False
bootstrap_kill_lightning = True
bootstrap_impact_no_friendlyfire = True
bootstrap_prefix_tag = False
bootstrap_chat_filter = False

# Performance knobs (read by mod_bootstrap.py)
fxOptimize = True
fxCountScale = 0.45
fxCountMax = 120
mapScale = 1.0
...
# Chat performance/behavior toggles
chatLogToFile = True
chatRandomSuffix = True
